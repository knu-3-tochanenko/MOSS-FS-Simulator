...
/**
 * A process context. This contains all information needed by the file system
 * which is specific to a process.
 * 
 * @author Ray Ontko
 */
public class ProcessContext {
	...
	/**
	 * The array of file descriptors for open files. The integer file descriptors
	 * for kernel method calls are indexes into this array.
	 */
	public FileDescriptor[] openFiles = new FileDescriptor[MAX_OPEN_FILES];

	/**
	 * Construct a process context. By default, uid=1, gid=1, dir="/root", and
	 * umask=0000.
	 */
