...
/**
 * Reads standard input and writes to standard output and the named file. A
 * simple tee program for a simulated file system.
 * <p>
 * Usage:
 * 
 * <pre>
...
public class tee {
	...
	/**
	 * The size of the buffer to be used for reading from the file. A buffer of this
	 * size is filled before writing to the output file.
	 */
