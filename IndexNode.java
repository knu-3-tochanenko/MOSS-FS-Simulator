...
public class IndexNode {
	...
	/**
	 * Maximum number of blocks in a file. If indirect, doubleIndirect, or
	 * tripleIndirect blocks are implemented, this number will need to be increased.
	 */
	...
	/**
	 * Array of direct blocks containing the block addresses for the first
	 * MAX_DIRECT_BLOCKS blocks of the file. Note that each element in the array is
	 * stored as a 3-byte number on disk.
	 */
	private int directBlocks[] = { FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK,
			FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK,
			FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK, FileSystem.NOT_A_BLOCK };
	 ...
	 * This is traditionally implemented as the number of seconds past 1970/01/01
	 * 00:00:00
	 */
	private int atime = 0;
	...
	/*
	 * Not yet implemented. The date and time at which this file was created. This
	 * is traditionally implemented as the number of seconds past 1970/01/01
	 * 00:00:00
	 */
	private int ctime = 0;
	...
	/**
	 * Sets the mode for this IndexNode. This is the file type and file protection
	 * information.
	 */
	...
	/**
	 * Gets the mode for this IndexNode. This is the file type and file protection
	 * information.
	 */
	 ...
	 * @return the address of the block, a number between zero and one less than the
	 ...
	 * 
	 * @param block   the sequential block number
	 * @param address the address of the block, a number between zero and one less
	 *                than the number of blocks in the file system
	 * @exception java.lang.Exception if the block number is invalid
	 */
	...
	/**
	 * Writes the contents of an index node to a byte array. This is used to copy
	 * the bytes which correspond to the disk image of the index node onto a block
	 * buffer so that they may be written to the file system.
	 * 
	 * @param buffer the buffer to which bytes should be written
	 * @param offset the offset from the beginning of the buffer at which bytes
	 *               should be written
	 */
	...
	/**
	 * Reads the contents of an index node from a byte array. This is used to copy
	 * the bytes which correspond to the disk image of the index node from a block
	 * buffer that has been read from the file system.
	 * 
